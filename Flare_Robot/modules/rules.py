...
GET_RULES_HANDLER = CommandHandler("orules", get_rules, filters=Filters.group)
SET_RULES_HANDLER = CommandHandler("osetrules", set_rules, filters=Filters.group)
RESET_RULES_HANDLER = CommandHandler("oclearrules", clear_rules, filters=Filters.group)
